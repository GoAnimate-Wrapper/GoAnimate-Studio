package
{
   ...
   public class _anifire_studio_skins_SimpleProductExplorerSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_studio_skins_SimpleProductExplorerSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         SimpleProductExplorerSkin.watcherSetupUtil = new _anifire_studio_skins_SimpleProductExplorerSkinWatcherSetupUtil();
      }
