package anifire.component.widgets
{
   ...
   public class GroupHBarChartWidget extends WidgetMaker
   {
      
      public static const INNER_BAR_OVERLAP_RATIO:Number = 0.2;
      
      public static const INNER_MARGIN:Number = 10;
      ...
      public function GroupHBarChartWidget()
      {
         super();
      }
      ...
      {
         var _loc1_:GroupBarChartBasePart = new GroupBarChartBasePart();
      ...
      {
         var _loc2_:WidgetPart = new GroupHBarChartPart();
      ...
      override protected function updateLayout() : void
      {
         ...
         var _loc1_:Number = INNER_MARGIN;
