package anifire.component.widgets
{
   ...
   public class CinematicAreaChartWidget extends CinematicChartWidget
   {
      ...
      public function CinematicAreaChartWidget()
      {
         super();
      }
      ...
      {
         var _loc2_:WidgetPart = new CinematicAreaChartPart();
