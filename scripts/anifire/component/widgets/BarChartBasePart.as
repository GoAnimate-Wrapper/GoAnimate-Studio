package anifire.component.widgets
{
   ...
   public class BarChartBasePart extends WidgetBasePart
   {
      ...
      public function BarChartBasePart()
      {
         super();
      }
      ...
      override public function draw() : void
      {
         ...
         if(_widgetMaker.displayAxis)
         {
            ...
            _loc4_ = _widgetMaker.combinedMaxValue - _widgetMaker.combinedNegativeMaxValue;
            _loc5_ = _widgetMaker.combinedNegativeMaxValue / _loc4_;
