package anifire.component.widgets
{
   ...
   public class GroupBarChartWidget extends WidgetMaker
   {
      
      public static const INNER_BAR_OVERLAP_RATIO:Number = 0.2;
      ...
      public function GroupBarChartWidget()
      {
         super();
      }
      ...
      {
         return new GroupBarChartBasePart();
      }
      
      override protected function createPart(param1:WidgetPartModel) : WidgetPart
      {
         var _loc2_:WidgetPart = new GroupBarChartPart();
      ...
      override protected function postProcessContentBounds() : void
      {
         ...
         var _loc2_:Number = _basePart.contentBounds.height;
         var _loc3_:Number = -negativeMaxValue / _loc1_;
         if(_loc3_ > 0)
         {
            _loc4_ = _loc2_ + _labelPaddingBottom;
            _loc5_ = _loc4_ * _loc3_;
            if(_loc5_ < _labelPaddingBottom)
            {
               _loc2_ = _loc2_ - (_labelPaddingBottom - _loc5_);
            }
         }
         _basePart.contentBounds.height = _loc2_;
      }
      
      override protected function updateAnimation() : void
      {
         var _loc1_:Number = INNER_BAR_OVERLAP_RATIO * (_dataPartCount - 1);
         var _loc2_:Number = 0;
