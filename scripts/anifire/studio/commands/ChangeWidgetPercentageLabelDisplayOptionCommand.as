package anifire.studio.commands
{
   ...
   public class ChangeWidgetPercentageLabelDisplayOptionCommand extends ChangeWidgetCommand
   {
      ...
      public function ChangeWidgetPercentageLabelDisplayOptionCommand(param1:Widget, param2:Boolean, param3:Boolean = true, param4:Boolean = false)
      {
         super(param1,param3);
         _type = "ChangeWidgetPercentageLabelDisplayOptionCommand";
         this._isNewVisible = param2;
         this._isRadio = param4;
         this._isOldVisible = param1.displayInPercentage;
      }
