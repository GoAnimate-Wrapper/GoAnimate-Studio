package anifire.studio.skins
{
   ...
   public class RangeSelectorSliderSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function RangeSelectorSliderSkin()
      {
         super();
         mx_internal::_document = this;
         this.minHeight = 22;
         this.mxmlContent = [this._RangeSelectorSliderSkin_Button1_i(),this._RangeSelectorSliderSkin_Button2_i()];
         this.currentState = "normal";
         this._RangeSelectorSliderSkin_ClassFactory1_i();
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      private function _RangeSelectorSliderSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = RangeSelectorSliderSkinInnerClass0;
      ...
      private function _RangeSelectorSliderSkin_Button1_i() : Button
      {
      ...
      private function _RangeSelectorSliderSkin_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
         _loc1_.top = 0;
         _loc1_.bottom = 0;
