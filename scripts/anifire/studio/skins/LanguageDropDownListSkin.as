package anifire.studio.skins
{
   ...
   import anifire.studio.components.LanguageIcon;
   ...
   public class LanguageDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function LanguageDropDownListSkin()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_studio_skins_LanguageDropDownListSkinWatcherSetupUtil");
      ...
      private function _LanguageDropDownListSkin_Group1_i() : Group
      {
         ...
         _loc1_.mxmlContent = [this._LanguageDropDownListSkin_ArrowTipContainer1_i()];
         _loc1_.id = "dropDown";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _LanguageDropDownListSkin_ArrowTipContainer1_i() : ArrowTipContainer
      {
         ...
         _loc1_.offset = 10;
         _loc1_.content = [this._LanguageDropDownListSkin_Scroller1_i()];
