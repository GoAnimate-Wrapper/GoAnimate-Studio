package anifire.studio.skins
{
   ...
   public class FontAlignToggleButtonBarSkinInnerClass0 extends ButtonBarButton
   {
      ...
      public function FontAlignToggleButtonBarSkinInnerClass0()
      {
         super();
      }
      ...
      override public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         {
            this.skinClass = FontAlignToggleButtonBarFirstButtonSkin;
         };
      }
