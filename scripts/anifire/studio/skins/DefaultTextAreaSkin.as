package anifire.studio.skins
{
   ...
   public class DefaultTextAreaSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function DefaultTextAreaSkin()
      {
         super();
         mx_internal::_document = this;
         this.blendMode = "normal";
         this.mxmlContent = [this._DefaultTextAreaSkin_Rect1_i(),this._DefaultTextAreaSkin_Rect2_i(),this._DefaultTextAreaSkin_Rect3_i(),this._DefaultTextAreaSkin_Scroller1_i()];
         this.currentState = "normal";
         var _loc1_:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._DefaultTextAreaSkin_Label1_i);
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         if(getStyle("borderVisible") == true)
         {
            ...
            if(this.promptDisplay)
            {
               ...
               this.promptDisplay.setLayoutBoundsPosition(1,4);
            }
         }
         else
         {
      ...
      private function _DefaultTextAreaSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.bottom = 0;
         _loc1_.radiusX = 3;
         _loc1_.stroke = this._DefaultTextAreaSkin_SolidColorStroke1_i();
      ...
      private function _DefaultTextAreaSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _DefaultTextAreaSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.right = 1;
         ...
         _loc1_.bottom = 1;
         _loc1_.radiusX = 2;
         _loc1_.fill = this._DefaultTextAreaSkin_SolidColor1_i();
      ...
      private function _DefaultTextAreaSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _DefaultTextAreaSkin_Rect3_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.top = 1;
         ...
         _loc1_.height = 1;
         _loc1_.radiusX = 2;
         _loc1_.fill = this._DefaultTextAreaSkin_SolidColor2_c();
      ...
      private function _DefaultTextAreaSkin_SolidColor2_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 0;
         _loc1_.alpha = 0.12;
      ...
      private function _DefaultTextAreaSkin_Scroller1_i() : Scroller
      {
         ...
         _loc1_.viewport = this._DefaultTextAreaSkin_RichEditableText1_i();
         _loc1_.id = "scroller";
         if(!_loc1_.document)
         {
      ...
      private function _DefaultTextAreaSkin_RichEditableText1_i() : RichEditableText
      {
      ...
      private function _DefaultTextAreaSkin_Label1_i() : Label
      {
