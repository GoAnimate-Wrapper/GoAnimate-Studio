package anifire.studio.skins
{
   ...
   public class TinyRangeSelectorSliderSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function TinyRangeSelectorSliderSkin()
      {
         super();
         mx_internal::_document = this;
         this.minHeight = 22;
         this.mxmlContent = [this._TinyRangeSelectorSliderSkin_Button1_i(),this._TinyRangeSelectorSliderSkin_Button2_i()];
         this.currentState = "normal";
         this._TinyRangeSelectorSliderSkin_ClassFactory1_i();
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      private function _TinyRangeSelectorSliderSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = TinyRangeSelectorSliderSkinInnerClass0;
      ...
      private function _TinyRangeSelectorSliderSkin_Button1_i() : Button
      {
         ...
         _loc1_.setStyle("skinClass",TinyHSliderTrackSkin);
         _loc1_.id = "track";
         if(!_loc1_.document)
         {
      ...
      private function _TinyRangeSelectorSliderSkin_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.width = 20;
         _loc1_.tabEnabled = false;
         _loc1_.setStyle("skinClass",TinyHSliderThumbSkin);
         _loc1_.id = "thumb";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
