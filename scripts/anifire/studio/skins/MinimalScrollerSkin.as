package anifire.studio.skins
{
   ...
   public class MinimalScrollerSkin extends SparkSkin
   {
      ...
      public function MinimalScrollerSkin()
      {
         super();
         mx_internal::_document = this;
         this._MinimalScrollerSkin_ClassFactory2_i();
         this._MinimalScrollerSkin_ClassFactory1_i();
      }
      ...
      private function _MinimalScrollerSkin_ClassFactory2_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = MinimalScrollerSkinInnerClass1;
      ...
      private function _MinimalScrollerSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = MinimalScrollerSkinInnerClass0;
         _loc1_.properties = {"outerDocument":this};
