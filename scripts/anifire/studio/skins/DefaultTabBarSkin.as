package anifire.studio.skins
{
   ...
   public class DefaultTabBarSkin extends Skin implements IStateClient2
   {
      ...
      public function DefaultTabBarSkin()
      {
         ...
         this.mxmlContent = [this._DefaultTabBarSkin_Rect1_c(),this._DefaultTabBarSkin_Rect2_c(),this._DefaultTabBarSkin_RectangularDropShadow1_c(),this._DefaultTabBarSkin_Group1_c()];
      ...
      private function _DefaultTabBarSkin_Rect2_c() : Rect
      {
         ...
         _loc1_.fill = this._DefaultTabBarSkin_SolidColor2_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      ...
      private function _DefaultTabBarSkin_SolidColor2_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
      ...
      private function _DefaultTabBarSkin_RectangularDropShadow1_c() : RectangularDropShadow
      {
      ...
      private function _DefaultTabBarSkin_Group1_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.clipAndEnableScrolling = true;
         _loc1_.mxmlContent = [this._DefaultTabBarSkin_DataGroup1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _DefaultTabBarSkin_DataGroup1_i() : DataGroup
      {
         ...
         _loc1_.bottom = 10;
         _loc1_.clipAndEnableScrolling = true;
         _loc1_.layout = this._DefaultTabBarSkin_ButtonBarHorizontalLayout1_c();
      ...
      private function _DefaultTabBarSkin_ButtonBarHorizontalLayout1_c() : ButtonBarHorizontalLayout
      {
