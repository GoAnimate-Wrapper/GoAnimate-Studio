package anifire.studio.skins
{
   ...
   public class ColorPaletteDropDownSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
       
      
      public var _ColorPaletteDropDownSkin_SolidColor2:SolidColor;
      
      private var _358089761colorDisplay:Ellipse;
      ...
      public function ColorPaletteDropDownSkin()
      {
         ...
         bindings = this._ColorPaletteDropDownSkin_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_studio_skins_ColorPaletteDropDownSkinWatcherSetupUtil");
         ...
         {
            return ColorPaletteDropDownSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._ColorPaletteDropDownSkin_Button1_i(),this._ColorPaletteDropDownSkin_Ellipse1_i()];
         this.currentState = "normal";
         var _ColorPaletteDropDownSkin_PopUpAnchor1_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._ColorPaletteDropDownSkin_PopUpAnchor1_i,this._ColorPaletteDropDownSkin_PopUpAnchor1_r);
         states = [new State({
            "name":"normal",
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "itemsFactory":_ColorPaletteDropDownSkin_PopUpAnchor1_factory,
               "destination":null,
      ...
      {
         ColorPaletteDropDownSkin._watcherSetupUtil = param1;
      }
      ...
      private function _ColorPaletteDropDownSkin_PopUpAnchor1_i() : PopUpAnchor
      {
         ...
         _loc1_.popUp = this._ColorPaletteDropDownSkin_Group1_i();
         _loc1_.id = "popUp";
         if(!_loc1_.document)
         {
      ...
      private function _ColorPaletteDropDownSkin_PopUpAnchor1_r() : void
      {
      }
      
      private function _ColorPaletteDropDownSkin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.mxmlContent = [this._ColorPaletteDropDownSkin_Rect1_c(),this._ColorPaletteDropDownSkin_VGroup1_i(),this._ColorPaletteDropDownSkin_Group2_i()];
         _loc1_.id = "dropDown";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _ColorPaletteDropDownSkin_Rect1_c() : Rect
      {
         ...
         _loc1_.radiusX = 4;
         _loc1_.radiusY = 4;
         _loc1_.fill = this._ColorPaletteDropDownSkin_SolidColor1_c();
         _loc1_.stroke = this._ColorPaletteDropDownSkin_SolidColorStroke1_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _ColorPaletteDropDownSkin_SolidColor1_c() : SolidColor
      {
      ...
      private function _ColorPaletteDropDownSkin_SolidColorStroke1_c() : SolidColorStroke
      {
      ...
      private function _ColorPaletteDropDownSkin_VGroup1_i() : VGroup
      {
         ...
         _loc1_.mxmlContent = [this._ColorPaletteDropDownSkin_Scroller1_i(),this._ColorPaletteDropDownSkin_OpacitySlider1_i()];
      ...
      private function _ColorPaletteDropDownSkin_Scroller1_i() : Scroller
      {
         var _loc1_:Scroller = new Scroller();
         _loc1_.percentWidth = 100;
         _loc1_.maxHeight = 150;
         _loc1_.viewport = this._ColorPaletteDropDownSkin_DataGroup1_i();
      ...
      private function _ColorPaletteDropDownSkin_DataGroup1_i() : DataGroup
      {
         var _loc1_:DataGroup = new DataGroup();
         _loc1_.itemRenderer = this._ColorPaletteDropDownSkin_ClassFactory1_c();
         _loc1_.layout = this._ColorPaletteDropDownSkin_TileLayout1_i();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _ColorPaletteDropDownSkin_ClassFactory1_c() : ClassFactory
      {
      ...
      private function _ColorPaletteDropDownSkin_TileLayout1_i() : TileLayout
      {
      ...
      private function _ColorPaletteDropDownSkin_OpacitySlider1_i() : OpacitySlider
      {
      ...
      private function _ColorPaletteDropDownSkin_Group2_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.width = 0;
         _loc1_.height = 0;
         _loc1_.includeInLayout = false;
         _loc1_.mxmlContent = [this._ColorPaletteDropDownSkin_ColorInputPanel1_i()];
      ...
      private function _ColorPaletteDropDownSkin_ColorInputPanel1_i() : ColorInputPanel
      {
      ...
      private function _ColorPaletteDropDownSkin_Button1_i() : Button
      {
         ...
         _loc1_.setStyle("skinClass",RoundColorPickerOpenButtonSkin);
      ...
      private function _ColorPaletteDropDownSkin_Ellipse1_i() : Ellipse
      {
         var _loc1_:Ellipse = new Ellipse();
         _loc1_.width = 28;
         _loc1_.height = 28;
         _loc1_.fill = this._ColorPaletteDropDownSkin_SolidColor2_i();
         _loc1_.stroke = this._ColorPaletteDropDownSkin_SolidColorStroke2_c();
         _loc1_.filters = [this._ColorPaletteDropDownSkin_DropShadowFilter1_c()];
         _loc1_.initialized(this,"colorDisplay");
         this.colorDisplay = _loc1_;
         BindingManager.executeBindings(this,"colorDisplay",this.colorDisplay);
         return _loc1_;
      }
      
      private function _ColorPaletteDropDownSkin_SolidColor2_i() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         this._ColorPaletteDropDownSkin_SolidColor2 = _loc1_;
         BindingManager.executeBindings(this,"_ColorPaletteDropDownSkin_SolidColor2",this._ColorPaletteDropDownSkin_SolidColor2);
         return _loc1_;
      }
      
      private function _ColorPaletteDropDownSkin_SolidColorStroke2_c() : SolidColorStroke
      {
         var _loc1_:SolidColorStroke = new SolidColorStroke();
      ...
      private function _ColorPaletteDropDownSkin_DropShadowFilter1_c() : DropShadowFilter
      {
      ...
      private function _ColorPaletteDropDownSkin_bindingsSetup() : Array
      {
         var result:Array = [];
         ...
         {
            return hostComponent.selectedColor;
         },null,"_ColorPaletteDropDownSkin_SolidColor2.color");
         return result;
      }
      
      [Bindable(event="propertyChange")]
      public function get colorDisplay() : Ellipse
      {
         return this._358089761colorDisplay;
      }
      
      public function set colorDisplay(param1:Ellipse) : void
      {
