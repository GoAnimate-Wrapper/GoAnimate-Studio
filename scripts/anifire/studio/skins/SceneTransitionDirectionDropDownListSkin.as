package anifire.studio.skins
{
   ...
   public class SceneTransitionDirectionDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function SceneTransitionDirectionDropDownListSkin()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_studio_skins_SceneTransitionDirectionDropDownListSkinWatcherSetupUtil");
      ...
      private function _SceneTransitionDirectionDropDownListSkin_Group1_i() : Group
      {
         ...
         _loc1_.mxmlContent = [this._SceneTransitionDirectionDropDownListSkin_RectangularDropShadow1_i(),this._SceneTransitionDirectionDropDownListSkin_Rect1_i(),this._SceneTransitionDirectionDropDownListSkin_Scroller1_i()];
         _loc1_.id = "dropDown";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
