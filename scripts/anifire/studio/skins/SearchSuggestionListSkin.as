...
{
	import anifire.studio.components.SearchSuggestionListItemRenderer;
	...
	public class SearchSuggestionListSkin extends SparkSkin implements IStateClient2
	{
		...
		public function SearchSuggestionListSkin()
		{
			super();
			...
			this.mxmlContent = [this._SearchSuggestionListSkin_RectangularDropShadow1_i(),this._SearchSuggestionListSkin_Rect1_i(),this._SearchSuggestionListSkin_Scroller1_i()];
		...
		private function _SearchSuggestionListSkin_RectangularDropShadow1_i() : RectangularDropShadow
		{
		...
		private function _SearchSuggestionListSkin_Rect1_i() : Rect
		{
			...
			_loc1_.bottom = 0;
			_loc1_.radiusX = 3;
			_loc1_.stroke = this._SearchSuggestionListSkin_SolidColorStroke1_i();
			_loc1_.fill = this._SearchSuggestionListSkin_SolidColor1_i();
		...
		private function _SearchSuggestionListSkin_SolidColorStroke1_i() : SolidColorStroke
		{
		...
		private function _SearchSuggestionListSkin_SolidColor1_i() : SolidColor
		{
		...
		private function _SearchSuggestionListSkin_Scroller1_i() : Scroller
		{
			...
			_loc1_.viewport = this._SearchSuggestionListSkin_DataGroup1_i();
		...
		private function _SearchSuggestionListSkin_DataGroup1_i() : DataGroup
		{
			var _loc1_:DataGroup = new DataGroup();
			_loc1_.itemRenderer = this._SearchSuggestionListSkin_ClassFactory1_c();
			_loc1_.layout = this._SearchSuggestionListSkin_VerticalLayout1_c();
			_loc1_.id = "dataGroup";
			if(!_loc1_.document)
			{
				_loc1_.document = this;
		...
		private function _SearchSuggestionListSkin_ClassFactory1_c() : ClassFactory
		{
			var _loc1_:ClassFactory = new ClassFactory();
			_loc1_.generator = SearchSuggestionListItemRenderer;
			return _loc1_;
		}
		
		private function _SearchSuggestionListSkin_VerticalLayout1_c() : VerticalLayout
		{
