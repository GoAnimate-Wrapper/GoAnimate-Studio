package anifire.studio.skins
{
   ...
   public class PropStateDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function PropStateDropDownListSkin()
      {
         ...
         bindings = this._PropStateDropDownListSkin_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_studio_skins_PropStateDropDownListSkinWatcherSetupUtil");
         ...
         {
            return PropStateDropDownListSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._PropStateDropDownListSkin_Button1_i(),this._PropStateDropDownListSkin_Label1_i()];
         this.currentState = "normal";
         var _PropStateDropDownListSkin_PopUpAnchor1_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._PropStateDropDownListSkin_PopUpAnchor1_i,this._PropStateDropDownListSkin_PopUpAnchor1_r);
         states = [new State({
            "name":"normal",
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "itemsFactory":_PropStateDropDownListSkin_PopUpAnchor1_factory,
               "destination":null,
      ...
      {
         PropStateDropDownListSkin._watcherSetupUtil = param1;
      }
      ...
      private function _PropStateDropDownListSkin_PopUpAnchor1_i() : PopUpAnchor
      {
         ...
         _loc1_.popUp = this._PropStateDropDownListSkin_Group1_i();
         _loc1_.id = "popUp";
         if(!_loc1_.document)
         {
      ...
      private function _PropStateDropDownListSkin_PopUpAnchor1_r() : void
      {
      }
      
      private function _PropStateDropDownListSkin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.mxmlContent = [this._PropStateDropDownListSkin_ArrowTipContainer1_i()];
         _loc1_.id = "dropDown";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _PropStateDropDownListSkin_ArrowTipContainer1_i() : ArrowTipContainer
      {
         ...
         _loc1_.targetWidth = 30;
         _loc1_.offset = 10;
         _loc1_.content = [this._PropStateDropDownListSkin_Scroller1_i()];
      ...
      private function _PropStateDropDownListSkin_Scroller1_i() : Scroller
      {
         ...
         _loc1_.viewport = this._PropStateDropDownListSkin_DataGroup1_i();
      ...
      private function _PropStateDropDownListSkin_DataGroup1_i() : DataGroup
      {
         var _loc1_:DataGroup = new DataGroup();
         _loc1_.itemRenderer = this._PropStateDropDownListSkin_ClassFactory1_c();
         _loc1_.layout = this._PropStateDropDownListSkin_VerticalLayout1_c();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _PropStateDropDownListSkin_ClassFactory1_c() : ClassFactory
      {
      ...
      private function _PropStateDropDownListSkin_VerticalLayout1_c() : VerticalLayout
      {
      ...
      private function _PropStateDropDownListSkin_Button1_i() : Button
      {
      ...
      private function _PropStateDropDownListSkin_Label1_i() : Label
      {
      ...
      private function _PropStateDropDownListSkin_bindingsSetup() : Array
      {
         var result:Array = [];
