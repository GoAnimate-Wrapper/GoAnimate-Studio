package anifire.studio.skins
{
   ...
   public class ForwardLinkButtonSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function ForwardLinkButtonSkin()
      {
         super();
         mx_internal::_document = this;
         this.mxmlContent = [this._ForwardLinkButtonSkin_Rect1_i(),this._ForwardLinkButtonSkin_Label1_i(),this._ForwardLinkButtonSkin_Path1_i()];
      ...
      private function _ForwardLinkButtonSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 1;
         _loc1_.bottom = 1;
         _loc1_.fill = this._ForwardLinkButtonSkin_SolidColor1_c();
      ...
      private function _ForwardLinkButtonSkin_SolidColor1_c() : SolidColor
      {
      ...
      private function _ForwardLinkButtonSkin_Label1_i() : Label
      {
      ...
      private function _ForwardLinkButtonSkin_Path1_i() : Path
      {
         var _loc1_:Path = new Path();
         _loc1_.verticalCenter = -1;
         _loc1_.right = 0;
         _loc1_.data = "M 0 0 l 4 4 l -4 4";
         _loc1_.stroke = this._ForwardLinkButtonSkin_SolidColorStroke1_c();
      ...
      private function _ForwardLinkButtonSkin_SolidColorStroke1_c() : SolidColorStroke
      {
