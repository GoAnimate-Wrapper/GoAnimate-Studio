package anifire.studio.skins
{
   ...
   public class TinyRangeSelectorSkin extends Skin implements IBindingClient
   {
      ...
      private var _1497762312triangle:Rect;
      ...
      public function TinyRangeSelectorSkin()
      {
         ...
         var bindings:Array = this._TinyRangeSelectorSkin_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_studio_skins_TinyRangeSelectorSkinWatcherSetupUtil");
         ...
         {
            return TinyRangeSelectorSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.minWidth = 60;
         this.minHeight = 32;
         this.mxmlContent = [this._TinyRangeSelectorSkin_Label1_i(),this._TinyRangeSelectorSkin_Group1_i(),this._TinyRangeSelectorSkin_Group2_i(),this._TinyRangeSelectorSkin_HSlider1_i(),this._TinyRangeSelectorSkin_HSlider2_i()];
         var i:uint = 0;
      ...
      {
         TinyRangeSelectorSkin._watcherSetupUtil = param1;
      }
      ...
      private function _TinyRangeSelectorSkin_Label1_i() : Label
      {
      ...
      private function _TinyRangeSelectorSkin_Group1_i() : Group
      {
         ...
         _loc1_.top = 11;
         _loc1_.bottom = 11;
         _loc1_.mxmlContent = [this._TinyRangeSelectorSkin_Rect1_i(),this._TinyRangeSelectorSkin_Rect2_i(),this._TinyRangeSelectorSkin_Rect3_i()];
      ...
      private function _TinyRangeSelectorSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._TinyRangeSelectorSkin_SolidColor1_c();
      ...
      private function _TinyRangeSelectorSkin_SolidColor1_c() : SolidColor
      {
      ...
      private function _TinyRangeSelectorSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._TinyRangeSelectorSkin_SolidColor2_c();
      ...
      private function _TinyRangeSelectorSkin_SolidColor2_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
      ...
      private function _TinyRangeSelectorSkin_Rect3_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._TinyRangeSelectorSkin_SolidColor3_c();
      ...
      private function _TinyRangeSelectorSkin_SolidColor3_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 5824968;
         _loc1_.alpha = 0;
      ...
      private function _TinyRangeSelectorSkin_Group2_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.left = 7;
         _loc1_.right = 7;
         _loc1_.top = 11;
         _loc1_.bottom = 11;
         _loc1_.mxmlContent = [this._TinyRangeSelectorSkin_Rect4_c()];
      ...
      private function _TinyRangeSelectorSkin_Rect4_c() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 0;
         _loc1_.right = 0;
         ...
         _loc1_.bottom = 0;
         _loc1_.radiusX = 0;
         _loc1_.fill = this._TinyRangeSelectorSkin_SolidColor4_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _TinyRangeSelectorSkin_SolidColor4_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         return _loc1_;
      }
      
      private function _TinyRangeSelectorSkin_HSlider1_i() : HSlider
      {
         ...
         _loc1_.setStyle("skinClass",TinyRangeSelectorSliderSkin);
         _loc1_.id = "endSlider";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _TinyRangeSelectorSkin_HSlider2_i() : HSlider
      {
         var _loc1_:HSlider = new HSlider();
         _loc1_.verticalCenter = 0;
         _loc1_.left = 0;
      ...
      private function _TinyRangeSelectorSkin_bindingsSetup() : Array
      {
         var _loc1_:Array = [];
      ...
      [Bindable(event="propertyChange")]
      public function get triangle() : Rect
      {
         return this._1497762312triangle;
      }
      
      public function set triangle(param1:Rect) : void
      {
