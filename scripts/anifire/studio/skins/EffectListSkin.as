package anifire.studio.skins
{
   ...
   public class EffectListSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function EffectListSkin()
      {
         super();
         mx_internal::_document = this;
         this.minWidth = 32;
         this.blendMode = "normal";
         this.mxmlContent = [this._EffectListSkin_Scroller1_i()];
         this.currentState = "normal";
         this._EffectListSkin_ClassFactory1_i();
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      private function _EffectListSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = EffectListSkinInnerClass0;
      ...
      private function _EffectListSkin_Scroller1_i() : Scroller
      {
         ...
         _loc1_.viewport = this._EffectListSkin_DataGroup1_i();
         _loc1_.id = "scroller";
         if(!_loc1_.document)
         {
      ...
      private function _EffectListSkin_DataGroup1_i() : DataGroup
      {
         var _loc1_:DataGroup = new DataGroup();
         _loc1_.itemRenderer = this._EffectListSkin_ClassFactory2_c();
         _loc1_.layout = this._EffectListSkin_VerticalLayout1_c();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _EffectListSkin_ClassFactory2_c() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
      ...
      private function _EffectListSkin_VerticalLayout1_c() : VerticalLayout
      {
