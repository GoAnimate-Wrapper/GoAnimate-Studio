package anifire.studio.skins
{
   ...
   public class SimpleProductExplorerSkin extends Skin implements IBindingClient, IStateClient2
   {
      ...
      public var _SimpleProductExplorerSkin_VGroup1:VGroup;
      ...
      public function SimpleProductExplorerSkin()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_studio_skins_SimpleProductExplorerSkinWatcherSetupUtil");
         ...
         this.mxmlContent = [this._SimpleProductExplorerSkin_Rect1_c(),this._SimpleProductExplorerSkin_List1_i(),this._SimpleProductExplorerSkin_VGroup1_i()];
         this.currentState = "normal";
         var _SimpleProductExplorerSkin_Group1_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._SimpleProductExplorerSkin_Group1_i);
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
            ...
            "overrides":[new AddItems().initializeFromObject({
               "itemsFactory":_SimpleProductExplorerSkin_Group1_factory,
               "destination":null,
               "propertyName":"mxmlContent",
               "position":"after",
               "relativeTo":["_SimpleProductExplorerSkin_VGroup1"]
            })]
         }),new State({
      ...
      private function _SimpleProductExplorerSkin_List1_i() : List
      {
         ...
         _loc1_.top = 1;
         _loc1_.bottom = 1;
         _loc1_.setStyle("skinClass",SimpleProductListSkin);
      ...
      private function _SimpleProductExplorerSkin_VGroup1_i() : VGroup
      {
         ...
         _loc1_.id = "_SimpleProductExplorerSkin_VGroup1";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._SimpleProductExplorerSkin_VGroup1 = _loc1_;
         BindingManager.executeBindings(this,"_SimpleProductExplorerSkin_VGroup1",this._SimpleProductExplorerSkin_VGroup1);
         return _loc1_;
      }
      ...
      private function _SimpleProductExplorerSkin_Group1_i() : Group
      {
         ...
         _loc1_.right = 0;
         _loc1_.bottom = 1;
         _loc1_.mxmlContent = [this._SimpleProductExplorerSkin_Rect2_c(),this._SimpleProductExplorerSkin_BusyIndicator1_c()];
      ...
      private function _SimpleProductExplorerSkin_BusyIndicator1_c() : BusyIndicator
      {
      ...
      private function _SimpleProductExplorerSkin_bindingsSetup() : Array
      {
         ...
         },null,"_SimpleProductExplorerSkin_VGroup1.visible");
         return result;
      }
