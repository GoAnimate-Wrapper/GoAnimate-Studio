package anifire.studio.skins
{
   ...
   public class LinkArrowBlackButtonSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function LinkArrowBlackButtonSkin()
      {
         super();
         mx_internal::_document = this;
         this.mxmlContent = [this._LinkArrowBlackButtonSkin_Rect1_i(),this._LinkArrowBlackButtonSkin_HGroup1_c()];
      ...
      private function _LinkArrowBlackButtonSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 1;
         _loc1_.bottom = 1;
         _loc1_.fill = this._LinkArrowBlackButtonSkin_SolidColor1_c();
      ...
      private function _LinkArrowBlackButtonSkin_SolidColor1_c() : SolidColor
      {
      ...
      private function _LinkArrowBlackButtonSkin_HGroup1_c() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.mxmlContent = [this._LinkArrowBlackButtonSkin_Path1_i(),this._LinkArrowBlackButtonSkin_Label1_i(),this._LinkArrowBlackButtonSkin_Path2_i()];
         if(!_loc1_.document)
         {
      ...
      private function _LinkArrowBlackButtonSkin_Path1_i() : Path
      {
         var _loc1_:Path = new Path();
         _loc1_.stroke = this._LinkArrowBlackButtonSkin_SolidColorStroke1_c();
      ...
      private function _LinkArrowBlackButtonSkin_SolidColorStroke1_c() : SolidColorStroke
      {
      ...
      private function _LinkArrowBlackButtonSkin_Label1_i() : Label
      {
      ...
      private function _LinkArrowBlackButtonSkin_Path2_i() : Path
      {
         var _loc1_:Path = new Path();
         _loc1_.stroke = this._LinkArrowBlackButtonSkin_SolidColorStroke2_c();
      ...
      private function _LinkArrowBlackButtonSkin_SolidColorStroke2_c() : SolidColorStroke
      {
         var _loc1_:SolidColorStroke = new SolidColorStroke();
         _loc1_.weight = 2;
         _loc1_.caps = "square";
