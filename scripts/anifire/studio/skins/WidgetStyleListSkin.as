...
{
   import anifire.studio.components.WidgetStyleThumbRenderer;
   ...
   public class WidgetStyleListSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function WidgetStyleListSkin()
      {
         super();
         mx_internal::_document = this;
         this.minWidth = 112;
         this.blendMode = "normal";
         this.mxmlContent = [this._WidgetStyleListSkin_Rect1_i(),this._WidgetStyleListSkin_Scroller1_i()];
         this.currentState = "normal";
         this._WidgetStyleListSkin_ClassFactory1_i();
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      private function _WidgetStyleListSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = WidgetStyleListSkinInnerClass0;
      ...
      private function _WidgetStyleListSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 1;
         _loc1_.bottom = 1;
         _loc1_.fill = this._WidgetStyleListSkin_SolidColor1_i();
      ...
      private function _WidgetStyleListSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _WidgetStyleListSkin_Scroller1_i() : Scroller
      {
         ...
         _loc1_.viewport = this._WidgetStyleListSkin_DataGroup1_i();
         _loc1_.id = "scroller";
         if(!_loc1_.document)
         {
      ...
      private function _WidgetStyleListSkin_DataGroup1_i() : DataGroup
      {
         var _loc1_:DataGroup = new DataGroup();
         _loc1_.itemRenderer = this._WidgetStyleListSkin_ClassFactory2_c();
         _loc1_.layout = this._WidgetStyleListSkin_TileLayout1_c();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _WidgetStyleListSkin_ClassFactory2_c() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
      ...
      private function _WidgetStyleListSkin_TileLayout1_c() : TileLayout
      {
