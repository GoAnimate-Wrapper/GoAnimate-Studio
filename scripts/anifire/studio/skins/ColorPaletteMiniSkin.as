package anifire.studio.skins
{
   ...
   public class ColorPaletteMiniSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function ColorPaletteMiniSkin()
      {
         super();
         mx_internal::_document = this;
         this.minWidth = 20;
         this.blendMode = "normal";
         this.mxmlContent = [this._ColorPaletteMiniSkin_Rect1_i(),this._ColorPaletteMiniSkin_Scroller1_i()];
         this.currentState = "normal";
         this._ColorPaletteMiniSkin_ClassFactory1_i();
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      private function _ColorPaletteMiniSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = ColorPaletteMiniSkinInnerClass0;
      ...
      private function _ColorPaletteMiniSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 1;
         _loc1_.bottom = 1;
         _loc1_.fill = this._ColorPaletteMiniSkin_SolidColor1_i();
      ...
      private function _ColorPaletteMiniSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _ColorPaletteMiniSkin_Scroller1_i() : Scroller
      {
         ...
         _loc1_.viewport = this._ColorPaletteMiniSkin_DataGroup1_i();
         _loc1_.id = "scroller";
         if(!_loc1_.document)
         {
      ...
      private function _ColorPaletteMiniSkin_DataGroup1_i() : DataGroup
      {
         var _loc1_:DataGroup = new DataGroup();
         _loc1_.itemRenderer = this._ColorPaletteMiniSkin_ClassFactory2_c();
         _loc1_.layout = this._ColorPaletteMiniSkin_HorizontalLayout1_c();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _ColorPaletteMiniSkin_ClassFactory2_c() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = ColorPaletteMiniItemRenderer;
         return _loc1_;
      }
      
      private function _ColorPaletteMiniSkin_HorizontalLayout1_c() : HorizontalLayout
      {
