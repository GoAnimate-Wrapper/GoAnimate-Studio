package anifire.studio.skins
{
   ...
   public class HintedTextInputSkin extends SparkSkin implements IStateClient2
   {
      ...
      public var _HintedTextInputSkin_HGroup1:HGroup;
      ...
      private var _1029028923hintDisplay:Label;
      ...
      public function HintedTextInputSkin()
      {
         super();
         mx_internal::_document = this;
         this.blendMode = "normal";
         this.minHeight = 32;
         this.mxmlContent = [this._HintedTextInputSkin_Rect1_i(),this._HintedTextInputSkin_Rect2_i(),this._HintedTextInputSkin_Rect3_i(),this._HintedTextInputSkin_HGroup1_i()];
         this.currentState = "normal";
         var _loc1_:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._HintedTextInputSkin_Label2_i);
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "position":"after",
               "relativeTo":["_HintedTextInputSkin_HGroup1"]
            })]
         }),new State({
      ...
      private function _HintedTextInputSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.bottom = 0;
         _loc1_.radiusX = 3;
         _loc1_.stroke = this._HintedTextInputSkin_SolidColorStroke1_i();
      ...
      private function _HintedTextInputSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _HintedTextInputSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.right = 1;
         ...
         _loc1_.bottom = 1;
         _loc1_.radiusX = 2;
         _loc1_.fill = this._HintedTextInputSkin_SolidColor1_i();
      ...
      private function _HintedTextInputSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _HintedTextInputSkin_Rect3_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.top = 1;
         ...
         _loc1_.height = 1;
         _loc1_.radiusX = 2;
         _loc1_.fill = this._HintedTextInputSkin_SolidColor2_c();
      ...
      private function _HintedTextInputSkin_SolidColor2_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 0;
         _loc1_.alpha = 0.12;
      ...
      private function _HintedTextInputSkin_HGroup1_i() : HGroup
      {
         ...
         _loc1_.mxmlContent = [this._HintedTextInputSkin_Label1_i(),this._HintedTextInputSkin_RichEditableText1_i()];
         _loc1_.id = "_HintedTextInputSkin_HGroup1";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._HintedTextInputSkin_HGroup1 = _loc1_;
         BindingManager.executeBindings(this,"_HintedTextInputSkin_HGroup1",this._HintedTextInputSkin_HGroup1);
         return _loc1_;
      }
      
      private function _HintedTextInputSkin_Label1_i() : Label
      {
         var _loc1_:Label = new Label();
         _loc1_.setStyle("color",9937845);
         _loc1_.id = "hintDisplay";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this.hintDisplay = _loc1_;
         BindingManager.executeBindings(this,"hintDisplay",this.hintDisplay);
         return _loc1_;
      }
      
      private function _HintedTextInputSkin_RichEditableText1_i() : RichEditableText
      {
      ...
      private function _HintedTextInputSkin_Label2_i() : Label
      {
         var _loc1_:Label = new Label();
      ...
      {
         return this._1029028923hintDisplay;
      }
      
      public function set hintDisplay(param1:Label) : void
      {
         var _loc2_:Object = this._1029028923hintDisplay;
         if(_loc2_ !== param1)
         {
            this._1029028923hintDisplay = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"hintDisplay",_loc2_,param1));
            }
         }
      }
