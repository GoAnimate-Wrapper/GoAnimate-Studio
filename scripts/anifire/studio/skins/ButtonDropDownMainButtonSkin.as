package anifire.studio.skins
{
   ...
   public class ButtonDropDownMainButtonSkin extends SparkSkin implements IStateClient2
   {
      ...
      private var _970248796_ButtonDropDownMainButtonSkin_SolidColor1:SolidColor;
      ...
      public function ButtonDropDownMainButtonSkin()
      {
         ...
         this.minWidth = 40;
         this.minHeight = 32;
         this.mxmlContent = [this._ButtonDropDownMainButtonSkin_Rect1_i(),this._ButtonDropDownMainButtonSkin_HGroup1_i()];
         ...
         states = [new State({
            ...
            "overrides":[new SetProperty().initializeFromObject({
               "target":"_ButtonDropDownMainButtonSkin_SolidColor1",
               "name":"color",
               "value":170629
            })]
         }),new State({
      ...
      private function _ButtonDropDownMainButtonSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.fill = this._ButtonDropDownMainButtonSkin_SolidColor1_i();
      ...
      private function _ButtonDropDownMainButtonSkin_SolidColor1_i() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 4439205;
         this._ButtonDropDownMainButtonSkin_SolidColor1 = _loc1_;
         BindingManager.executeBindings(this,"_ButtonDropDownMainButtonSkin_SolidColor1",this._ButtonDropDownMainButtonSkin_SolidColor1);
         return _loc1_;
      }
      
      private function _ButtonDropDownMainButtonSkin_HGroup1_i() : HGroup
      {
      ...
      public function get _ButtonDropDownMainButtonSkin_SolidColor1() : SolidColor
      {
         return this._970248796_ButtonDropDownMainButtonSkin_SolidColor1;
      }
      
      public function set _ButtonDropDownMainButtonSkin_SolidColor1(param1:SolidColor) : void
      {
         var _loc2_:Object = this._970248796_ButtonDropDownMainButtonSkin_SolidColor1;
         if(_loc2_ !== param1)
         {
            this._970248796_ButtonDropDownMainButtonSkin_SolidColor1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_ButtonDropDownMainButtonSkin_SolidColor1",_loc2_,param1));
            }
         }
      }
