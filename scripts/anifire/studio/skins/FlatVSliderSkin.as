package anifire.studio.skins
{
   ...
   public class FlatVSliderSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public var _FlatVSliderSkin_Rect1:Rect;
      ...
      public function FlatVSliderSkin()
      {
         ...
         bindings = this._FlatVSliderSkin_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_studio_skins_FlatVSliderSkinWatcherSetupUtil");
         ...
         {
            return FlatVSliderSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.blendMode = "layer";
         this.minHeight = 22;
         this.mxmlContent = [this._FlatVSliderSkin_Button1_i(),this._FlatVSliderSkin_Rect1_i(),this._FlatVSliderSkin_Group1_i(),this._FlatVSliderSkin_Button2_i()];
         this.currentState = "normal";
         this._FlatVSliderSkin_ClassFactory1_i();
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      {
         FlatVSliderSkin._watcherSetupUtil = param1;
      }
      ...
      private function _FlatVSliderSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = FlatVSliderSkinInnerClass0;
      ...
      private function _FlatVSliderSkin_Button1_i() : Button
      {
         ...
         _loc1_.setStyle("skinClass",FlatVSliderTrackSkin);
         _loc1_.id = "track";
         if(!_loc1_.document)
         {
      ...
      private function _FlatVSliderSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.radiusY = 2;
         _loc1_.width = 5;
         _loc1_.fill = this._FlatVSliderSkin_SolidColor1_c();
         _loc1_.initialized(this,"_FlatVSliderSkin_Rect1");
         this._FlatVSliderSkin_Rect1 = _loc1_;
         BindingManager.executeBindings(this,"_FlatVSliderSkin_Rect1",this._FlatVSliderSkin_Rect1);
         return _loc1_;
      }
      
      private function _FlatVSliderSkin_SolidColor1_c() : SolidColor
      {
      ...
      private function _FlatVSliderSkin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.bottom = 0;
         _loc1_.left = 0;
         _loc1_.right = 0;
         _loc1_.mxmlContent = [this._FlatVSliderSkin_Rect2_c()];
         _loc1_.id = "trackMask";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _FlatVSliderSkin_Rect2_c() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 0;
         _loc1_.right = 0;
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._FlatVSliderSkin_SolidColor2_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _FlatVSliderSkin_SolidColor2_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
      ...
      private function _FlatVSliderSkin_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
         _loc1_.left = 0;
         _loc1_.right = 0;
         _loc1_.height = 20;
         _loc1_.tabEnabled = false;
         _loc1_.setStyle("skinClass",FlatVSliderThumbSkin);
         _loc1_.id = "thumb";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _FlatVSliderSkin_bindingsSetup() : Array
      {
         var result:Array = [];
         result[0] = new Binding(this,null,null,"_FlatVSliderSkin_Rect1.mask","trackMask");
         result[1] = new Binding(this,function():Number
         {
            return this.height - thumb.y - 10;
         },null,"trackMask.height");
         return result;
      }
