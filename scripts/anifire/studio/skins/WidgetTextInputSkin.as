package anifire.studio.skins
{
   ...
   public class WidgetTextInputSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function WidgetTextInputSkin()
      {
         super();
         mx_internal::_document = this;
         this.blendMode = "normal";
         this.mxmlContent = [this._WidgetTextInputSkin_Rect1_i(),this._WidgetTextInputSkin_Rect2_i(),this._WidgetTextInputSkin_RichEditableText1_i()];
         this.currentState = "normal";
         var _loc1_:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._WidgetTextInputSkin_Label1_i);
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      private function _WidgetTextInputSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.stroke = this._WidgetTextInputSkin_SolidColorStroke1_i();
      ...
      private function _WidgetTextInputSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _WidgetTextInputSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.right = 1;
         _loc1_.top = 1;
         _loc1_.bottom = 1;
         _loc1_.fill = this._WidgetTextInputSkin_SolidColor1_i();
      ...
      private function _WidgetTextInputSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _WidgetTextInputSkin_RichEditableText1_i() : RichEditableText
      {
      ...
      private function _WidgetTextInputSkin_Label1_i() : Label
      {
