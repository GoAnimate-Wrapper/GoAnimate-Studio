package anifire.studio.skins
{
   ...
   public class FlatNumericStepperIncrementButtonSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function FlatNumericStepperIncrementButtonSkin()
      {
         super();
         mx_internal::_document = this;
         this.mxmlContent = [this._FlatNumericStepperIncrementButtonSkin_Rect1_i(),this._FlatNumericStepperIncrementButtonSkin_Path1_i()];
      ...
      private function _FlatNumericStepperIncrementButtonSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.right = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._FlatNumericStepperIncrementButtonSkin_SolidColor1_c();
      ...
      private function _FlatNumericStepperIncrementButtonSkin_SolidColor1_c() : SolidColor
      {
      ...
      private function _FlatNumericStepperIncrementButtonSkin_Path1_i() : Path
      {
         var _loc1_:Path = new Path();
         _loc1_.horizontalCenter = 0;
         _loc1_.verticalCenter = 0;
         _loc1_.data = "M 0 4 l 4 -4 l 4 4";
         _loc1_.stroke = this._FlatNumericStepperIncrementButtonSkin_SolidColorStroke1_i();
      ...
      private function _FlatNumericStepperIncrementButtonSkin_SolidColorStroke1_i() : SolidColorStroke
      {
