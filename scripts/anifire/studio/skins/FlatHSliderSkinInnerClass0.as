package anifire.studio.skins
{
   ...
   public class FlatHSliderSkinInnerClass0 extends DataRenderer implements IBindingClient
   {
      ...
      private var _88844982outerDocument:FlatHSliderSkin;
      ...
      public function FlatHSliderSkinInnerClass0()
      {
         ...
         var bindings:Array = this._FlatHSliderSkinInnerClass0_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_studio_skins_FlatHSliderSkinInnerClass0WatcherSetupUtil");
         ...
         {
            return FlatHSliderSkinInnerClass0[param1];
         },bindings,watchers);
         ...
         this.minWidth = 40;
         this.y = -30;
         this.mxmlContent = [this._FlatHSliderSkinInnerClass0_Group1_i(),this._FlatHSliderSkinInnerClass0_Group2_i(),this._FlatHSliderSkinInnerClass0_Label1_i()];
         var i:uint = 0;
      ...
      {
         FlatHSliderSkinInnerClass0._watcherSetupUtil = param1;
      }
      ...
      private function _FlatHSliderSkinInnerClass0_Group1_i() : Group
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 8;
         _loc1_.mxmlContent = [this._FlatHSliderSkinInnerClass0_RectangularDropShadow1_i(),this._FlatHSliderSkinInnerClass0_Rect1_i()];
      ...
      private function _FlatHSliderSkinInnerClass0_RectangularDropShadow1_i() : RectangularDropShadow
      {
      ...
      private function _FlatHSliderSkinInnerClass0_Rect1_i() : Rect
      {
         ...
         _loc1_.bottom = 0;
         _loc1_.radiusX = 3;
         _loc1_.stroke = this._FlatHSliderSkinInnerClass0_SolidColorStroke1_i();
         _loc1_.fill = this._FlatHSliderSkinInnerClass0_SolidColor1_i();
      ...
      private function _FlatHSliderSkinInnerClass0_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _FlatHSliderSkinInnerClass0_SolidColor1_i() : SolidColor
      {
      ...
      private function _FlatHSliderSkinInnerClass0_Group2_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.horizontalCenter = 0;
         _loc1_.bottom = 0;
         _loc1_.mxmlContent = [this._FlatHSliderSkinInnerClass0_Path1_c(),this._FlatHSliderSkinInnerClass0_Path2_c()];
      ...
      private function _FlatHSliderSkinInnerClass0_Path1_c() : Path
      {
         var _loc1_:Path = new Path();
         _loc1_.data = "M 0 0 l 6 8 l 6 -8 Z";
         _loc1_.fill = this._FlatHSliderSkinInnerClass0_SolidColor2_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _FlatHSliderSkinInnerClass0_SolidColor2_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 16777215;
         return _loc1_;
      ...
      private function _FlatHSliderSkinInnerClass0_Path2_c() : Path
      {
         var _loc1_:Path = new Path();
         _loc1_.data = "M 0 0 l 6 8 l 6 -8";
         _loc1_.stroke = this._FlatHSliderSkinInnerClass0_SolidColorStroke2_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _FlatHSliderSkinInnerClass0_SolidColorStroke2_c() : SolidColorStroke
      {
         var _loc1_:SolidColorStroke = new SolidColorStroke();
         _loc1_.color = 10526623;
         return _loc1_;
      ...
      private function _FlatHSliderSkinInnerClass0_Label1_i() : Label
      {
      ...
      private function _FlatHSliderSkinInnerClass0_bindingsSetup() : Array
      {
         var _loc1_:Array = [];
      ...
      [Bindable(event="propertyChange")]
      public function get outerDocument() : FlatHSliderSkin
      {
         return this._88844982outerDocument;
      }
      
      public function set outerDocument(param1:FlatHSliderSkin) : void
      {
