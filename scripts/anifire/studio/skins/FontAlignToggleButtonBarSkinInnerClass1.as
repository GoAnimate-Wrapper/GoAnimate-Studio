package anifire.studio.skins
{
   ...
   public class FontAlignToggleButtonBarSkinInnerClass1 extends ButtonBarButton
   {
      ...
      public function FontAlignToggleButtonBarSkinInnerClass1()
      {
         super();
      }
      ...
      override public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         {
            this.skinClass = FontAlignToggleButtonBarMiddleButtonSkin;
         };
      }
