package anifire.studio.skins
{
	...
	public class AssetTransitionDestinationDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
	{
		...
		public function AssetTransitionDestinationDropDownListSkin()
		{
			...
			{
				watcherSetupUtilClass = getDefinitionByName("_anifire_studio_skins_AssetTransitionDestinationDropDownListSkinWatcherSetupUtil");
		...
		private function _AssetTransitionDestinationDropDownListSkin_Group1_i() : Group
		{
			...
			_loc1_.mxmlContent = [this._AssetTransitionDestinationDropDownListSkin_RectangularDropShadow1_i(),this._AssetTransitionDestinationDropDownListSkin_Rect1_i(),this._AssetTransitionDestinationDropDownListSkin_Scroller1_i()];
			_loc1_.id = "dropDown";
			if(!_loc1_.document)
			{
				_loc1_.document = this;
