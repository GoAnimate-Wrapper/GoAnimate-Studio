package anifire.studio.components
{
   ...
   public class TinyEffectTray extends Group
   {
      ...
      public function TinyEffectTray()
      {
         super();
         mx_internal::_document = this;
         this.mxmlContent = [this._TinyEffectTray_EffectList1_i()];
         this.addEventListener("creationComplete",this.___TinyEffectTray_Group1_creationComplete);
      }
      ...
      protected function onEffectTrayAction(param1:EffectTrayEvent) : void
      {
         ...
         this._console.updateOverTray(_loc2_);
      }
      ...
      private function _TinyEffectTray_EffectList1_i() : EffectList
      {
         var _loc1_:EffectList = new EffectList();
         _loc1_.percentWidth = 100;
         _loc1_.itemRenderer = this._TinyEffectTray_ClassFactory1_c();
      ...
      private function _TinyEffectTray_ClassFactory1_c() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = TinyEffectControlsItemRenderer;
         return _loc1_;
      }
      ...
      public function ___TinyEffectTray_Group1_creationComplete(param1:FlexEvent) : void
      {
         this.init();
      }
