   ...
   public class JFETP18 extends Sprite
   {
      ...
      public static function fep(param1:Array) : Object
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            while(_loc3_ < _loc6_)
            {
               _loc4_[_loc2_][_loc3_] = _loc7_ - _loc2_ - 1 + _loc3_ * _loc7_;
               _loc8_ = Math.max(_loc8_,_loc7_ - _loc2_ - 1 + _loc3_ * _loc7_);
               _loc3_++;
            }
            ...
            while(_loc3_ < _loc6_)
            {
               _loc4_[_loc5_ - _loc2_ - 1][_loc3_] = _loc7_ - _loc2_ - 1 + _loc3_ * _loc7_;
               _loc8_ = Math.max(_loc8_,_loc7_ - _loc2_ - 1 + _loc3_ * _loc7_);
               _loc3_++;
            }
            _loc2_--;
