package
{
   ...
   public class _anifire_studio_skins_ArrowTipMenuItemListSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_studio_skins_ArrowTipMenuItemListSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         ArrowTipMenuItemListSkin.watcherSetupUtil = new _anifire_studio_skins_ArrowTipMenuItemListSkinWatcherSetupUtil();
      }
