   ...
   public final class FSM___qdivrem extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         else
         {
            ...
            _loc1_ = int(li16(FSM___qdivrem.ebp + -42));
            _loc2_ = int(li16(FSM___qdivrem.ebp + -46));
            _loc3_ = int(li16(FSM___qdivrem.ebp + -40));
            _loc4_ = int(li16(FSM___qdivrem.ebp + -44));
            _loc1_ = _loc1_ << 16;
            _loc2_ = _loc2_ << 16;
