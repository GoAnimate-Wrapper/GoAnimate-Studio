package
{
   ...
   public class _anifire_studio_skins_FlatCheckBoxSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_studio_skins_FlatCheckBoxSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         FlatCheckBoxSkin.watcherSetupUtil = new _anifire_studio_skins_FlatCheckBoxSkinWatcherSetupUtil();
      }
